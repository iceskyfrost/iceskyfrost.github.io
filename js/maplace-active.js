            ...
            var LocsA = [
                {
                    ...
                    html: [ '<div class="ltn__map-item">',
                                ...
                                '<div class="btn-wrapper">',
                                    '<a href="javascript:;" class="btn btn-transparent btn-border btn-effect-4"><i class="fas fa-location-arrow"></i> 预约</a>',
                                    '<a href="javascript:;" class="btn btn-transparent btn-border btn-effect-3"><i class="fas fa-globe"></i> 查看网站</a>',
                                '</div>',
                            '</div>'
                        ].join(''),
                    图标: 'img/icons/map-marker-2.png',
